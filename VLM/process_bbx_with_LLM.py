...
def process_single_file(file_path):
    ...
    # print(pred_content["pred_bbx_reasoning"])
    ...
    try:
        ...
        # del pred_content['pred_bbx_x']
        # del pred_content["pred_bbx_y"]
        # del pred_content["pred_bbx_z"]
        # del pred_content["pred_bbx_width"]
        # del pred_content["pred_bbx_length"]
        # del pred_content["pred_bbx_height"]
...
def main(folder_dir):
    ...
    with Pool(num_workers) as pool:
        pool.starmap(process_single_file, target_file_lis)

if __name__ == "__main__":
    main(folder_dir = "./qwen2.5-vl-72b-instruct/part_level")